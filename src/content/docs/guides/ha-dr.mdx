...
<Aside type="caution" title="Azure RBAC: no native TTL enforcement">
...
See [Azure Provider — Security Considerations](/docs/guides/providers/azure/#security-considerations) for provider-level guidance.
</Aside>

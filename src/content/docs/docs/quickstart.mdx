...
2. **Start the local environment**
   ...
   `JITSUDO_SERVER` must point to the **gRPC port** (`8443`). You can also pass `--server localhost:8443` on individual commands, or set `server: localhost:8443` in `~/.jitsudo/config.yaml`.

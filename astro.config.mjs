			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'Quickstart: Real AWS Account', slug: 'guides/quickstart-aws' },
						{ label: 'Quickstart: Real GCP Account', slug: 'guides/quickstart-gcp' },
						{ label: 'Quickstart: Real Azure Subscription', slug: 'guides/quickstart-azure' },
						{ label: 'Quickstart: Real Kubernetes Cluster', slug: 'guides/quickstart-kubernetes' },
